...
export const RUSSIAN_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Да, Я хочу отправить ZERC',
    invalidAddress: 'Неверный адрес. Пока поддерживаются только прозрачные адреса.',
    invalidAmount: 'Неверная сумма.',
    invalidFee: 'Неверная комиссия.',
    zeroAmount: 'Количество ZERC должно быть больше 0.',
    notEnoughZERC: 'На кошельке недостаточно подтвержденного ZERC для транзакции.',
  ...
  PinPage: {
    ...
    newPinPageTitle: 'Настройка ZERC кошелька',
    verifyPinPageTitle: 'ZERC кошелек подтверждение PIN',
