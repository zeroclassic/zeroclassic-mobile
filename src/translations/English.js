...
export const ENGLISH_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'I want to send these ZERC',
    ...
    notEnoughZERC: 'Not enough confirmed ZERC in account to perform transaction.',
  ...
  PinPage: {
    ...
    verifyPinPageTitle: 'ZERC Wallet PIN Verification',
