...
export const DUTCH_TRANSLATION: TRANSLATION_OBJ = {
  ...
  SendPage: {
    ...
    confirmSend: 'Ik wil deze ZERC verzenden',
    ...
    notEnoughZERC: 'Niet genoeg ZERC om deze transactie uit te voeren.',
  ...
  PinPage: {
    ...
    newPinPageTitle: 'ZERC Portefuille Installatiewizard',
    verifyPinPageTitle: 'ZERC Portefuille PIN Verificatie',
